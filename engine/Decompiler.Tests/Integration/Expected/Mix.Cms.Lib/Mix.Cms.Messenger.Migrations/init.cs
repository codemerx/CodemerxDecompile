	...
	public class init : Migration
	{
		...
		protected override void BuildTargetModel(ModelBuilder modelBuilder)
		{
			...
			if (stackVariable6 == null)
			{
				...
				stackVariable6 = new Action<EntityTypeBuilder>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cBuildTargetModelu003eb__2_0);
			...
			if (stackVariable10 == null)
			{
				...
				stackVariable10 = new Action<EntityTypeBuilder>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cBuildTargetModelu003eb__2_1);
			...
			if (stackVariable14 == null)
			{
				...
				stackVariable14 = new Action<EntityTypeBuilder>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cBuildTargetModelu003eb__2_2);
			...
			if (stackVariable18 == null)
			{
				...
				stackVariable18 = new Action<EntityTypeBuilder>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cBuildTargetModelu003eb__2_3);
			...
			if (stackVariable22 == null)
			{
				...
				stackVariable22 = new Action<EntityTypeBuilder>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cBuildTargetModelu003eb__2_4);
			...
			if (stackVariable26 == null)
			{
				...
				stackVariable26 = new Action<EntityTypeBuilder>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cBuildTargetModelu003eb__2_5);
			...
			if (stackVariable30 == null)
			{
				...
				stackVariable30 = new Action<EntityTypeBuilder>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cBuildTargetModelu003eb__2_6);
			...
			if (stackVariable34 == null)
			{
				...
				stackVariable34 = new Action<EntityTypeBuilder>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cBuildTargetModelu003eb__2_7);
			...
			if (stackVariable38 == null)
			{
				...
				stackVariable38 = new Action<EntityTypeBuilder>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cBuildTargetModelu003eb__2_8);
			...
			if (stackVariable42 == null)
			{
				...
				stackVariable42 = new Action<EntityTypeBuilder>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cBuildTargetModelu003eb__2_9);
		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			if (stackVariable37 == null)
			{
				...
				stackVariable37 = new Func<ColumnsBuilder, u003cu003ef__AnonymousType57<OperationBuilder<AddColumnOperation>, OperationBuilder<AddColumnOperation>, OperationBuilder<AddColumnOperation>>>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cUpu003eb__0_10);
			...
			if (stackVariable39 == null)
			{
				...
				stackVariable39 = new Action<CreateTableBuilder<u003cu003ef__AnonymousType57<OperationBuilder<AddColumnOperation>, OperationBuilder<AddColumnOperation>, OperationBuilder<AddColumnOperation>>>>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cUpu003eb__0_11);
			...
			if (stackVariable44 == null)
			{
				...
				stackVariable44 = new Func<ColumnsBuilder, u003cu003ef__AnonymousType59<OperationBuilder<AddColumnOperation>, OperationBuilder<AddColumnOperation>, OperationBuilder<AddColumnOperation>, OperationBuilder<AddColumnOperation>, OperationBuilder<AddColumnOperation>>>(init.u003cu003ec.u003cu003e9, init.u003cu003ec.u003cUpu003eb__0_12);
