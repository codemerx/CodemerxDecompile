...
proto.GetMemberDefinitionResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    assemblyreferencefilepath: jspb.Message.getFieldWithDefault(msg, 4, "")
  };
...
proto.GetMemberDefinitionResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      var value = /** @type {string} */ (reader.readString());
      msg.setAssemblyreferencefilepath(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.GetMemberDefinitionResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getAssemblyreferencefilepath();
  if (f.length > 0) {
    writer.writeString(
      4,
      f
 ...
 * @return {boolean}
 */
proto.GetMemberDefinitionResponse.prototype.getIscrossassemblyreference = function() {
 ...
 * @return {!proto.GetMemberDefinitionResponse} returns this
 */
proto.GetMemberDefinitionResponse.prototype.setIscrossassemblyreference = function(value) {
  return jspb.Message.setProto3BooleanField(this, 3, value);
};


/**
 * optional string assemblyReferenceFilePath = 4;
 * @return {string}
 */
proto.GetMemberDefinitionResponse.prototype.getAssemblyreferencefilepath = function() {
 ...
 * @return {!proto.GetMemberDefinitionResponse} returns this
 */
proto.GetMemberDefinitionResponse.prototype.setAssemblyreferencefilepath = function(value) {
