...
namespace Mix.Cms.Lib.ViewModels.MixModuleDatas
{
	public class ImportViewModel : ViewModelBase<MixCmsContext, MixModuleData, ImportViewModel>
	{
		...
		public ImportViewModel(MixModuleData model, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
		{
			this.u003cFieldsu003ek__BackingField = "[]";
		...
		{
			stackVariable2 = _context.get_MixModule();
			V_0 = Expression.Parameter(Type.GetTypeFromHandle(// 
			// Current member / type: System.Void Mix.Cms.Lib.ViewModels.MixModuleDatas.ImportViewModel::ExpandView(Mix.Cms.Lib.Models.Cms.MixCmsContext,Microsoft.EntityFrameworkCore.Storage.IDbContextTransaction)
		...
		{
			V_0 = new ImportViewModel.u003cu003ec__DisplayClass77_0();
			V_0.name = name;
			return Enumerable.FirstOrDefault<ApiModuleDataValueViewModel>(this.get_DataProperties(), new Func<ApiModuleDataValueViewModel, bool>(V_0, ImportViewModel.u003cu003ec__DisplayClass77_0.u003cGetDataPropertyu003eb__0));
		}

		public string GetStringValue(string name)
		{
			V_0 = new ImportViewModel.u003cu003ec__DisplayClass75_0();
			V_0.name = name;
			V_1 = Enumerable.FirstOrDefault<ApiModuleDataValueViewModel>(this.get_DataProperties(), new Func<ApiModuleDataValueViewModel, bool>(V_0, ImportViewModel.u003cu003ec__DisplayClass75_0.u003cGetStringValueu003eb__0));
		...
		public static async Task<RepositoryResponse<List<ReadViewModel>>> UpdateInfosAsync(List<ReadViewModel> data)
		{
			...
			V_0.u003cu003et__builder.Start<ImportViewModel.u003cUpdateInfosAsyncu003ed__78>(ref V_0);
