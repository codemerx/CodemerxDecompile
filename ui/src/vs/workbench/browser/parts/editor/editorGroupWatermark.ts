...
const quickAccess: WatermarkEntry = { text: localize('watermark.quickAccess', "Go to Type"), id: 'workbench.action.quickOpen' };
const openFileNonMacOnly: WatermarkEntry = { text: localize('watermark.openFile', "Open Assembly"), id: 'workbench.action.files.openFile', mac: false };
...
const openFileOrFolderMacOnly: WatermarkEntry = { text: localize('watermark.openFileFolder', "Open Assembly"), id: 'workbench.action.files.openFileFolder', mac: true };
/* End AGPL */
