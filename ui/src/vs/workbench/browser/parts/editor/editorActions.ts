...
export class SplitEditorAction extends AbstractSplitEditorAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('splitEditor', "Split Code Viewer"), original: 'Split Code Viewer' },
			/* End AGPL */
			f1: true,
			keybinding: {
...
export class SplitEditorOrthogonalAction extends AbstractSplitEditorAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('splitEditorOrthogonal', "Split Code Viewer Orthogonal"), original: 'Split Code Viewer Orthogonal' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class SplitEditorLeftAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('splitEditorGroupLeft', "Split Code Viewer Left"), original: 'Split Code Viewer Left' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class SplitEditorRightAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('splitEditorGroupRight', "Split Code Viewer Right"), original: 'Split Code Viewer Right' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class SplitEditorUpAction extends ExecuteCommandAction {
	...
	/* AGPL */
	static readonly LABEL = localize('splitEditorGroupUp', "Split Code Viewer Up");
	/* End AGPL */
	...
	constructor() {
		super({
			id: SPLIT_EDITOR_UP,
			/* AGPL */
			title: { value: localize('splitEditorGroupUp', "Split Code Viewer Up"), original: 'Split Code Viewer Up' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class SplitEditorDownAction extends ExecuteCommandAction {
	...
	/* AGPL */
	static readonly LABEL = localize('splitEditorGroupDown', "Split Code Viewer Down");
	/* End AGPL */
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('splitEditorGroupDown', "Split Code Viewer Down"), original: 'Split Code Viewer Down' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class JoinTwoGroupsAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('joinTwoGroups', "Join Code Viewer Group with Next Group"), original: 'Join Code Viewer Group with Next Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		});
...
export class JoinAllGroupsAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('joinAllGroups', "Join All Code Viewer Groups"), original: 'Join All Code Viewer Groups' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		});
...
export class NavigateBetweenGroupsAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('navigateEditorGroups', "Navigate Between Code Viewer Groups"), original: 'Navigate Between Code Viewer Groups' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		});
...
export class FocusActiveGroupAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('focusActiveEditorGroup', "Focus Active Code Viewer Group"), original: 'Focus Active Code Viewer Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		});
...
export class FocusFirstGroupAction extends AbstractFocusGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('focusFirstEditorGroup', "Focus First Code Viewer Group"), original: 'Focus First Code Viewer Group' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class FocusLastGroupAction extends AbstractFocusGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('focusLastEditorGroup', "Focus Last Code Viewer Group"), original: 'Focus Last Code Viewer Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class FocusNextGroup extends AbstractFocusGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('focusNextGroup', "Focus Next Code Viewer Group"), original: 'Focus Next Code Viewer Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class FocusPreviousGroup extends AbstractFocusGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('focusPreviousGroup', "Focus Previous Code Viewer Group"), original: 'Focus Previous Code Viewer Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class FocusLeftGroup extends AbstractFocusGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('focusLeftGroup', "Focus Left Code Viewer Group"), original: 'Focus Left Code Viewer Group' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class FocusRightGroup extends AbstractFocusGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('focusRightGroup', "Focus Right Code Viewer Group"), original: 'Focus Right Code Viewer Group' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class FocusAboveGroup extends AbstractFocusGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('focusAboveGroup', "Focus Code Viewer Group Above"), original: 'Focus Code Viewer Group Above' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class FocusBelowGroup extends AbstractFocusGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('focusBelowGroup', "Focus Code Viewer Group Below"), original: 'Focus Code Viewer Group Below' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class CloseEditorAction extends Action {
	...
	/* AGPL */
	static readonly LABEL = localize('closeEditor', "Close Code Viewer");
	/* End AGPL */
...
export class RevertAndCloseEditorAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('revertAndCloseActiveEditor', "Revert and Close Code Viewer"), original: 'Revert and Close Code Viewer' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		});
...
export class CloseAllEditorGroupsAction extends AbstractCloseAllAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('closeAllGroups', "Close All Code Viewer Groups"), original: 'Close All Code Viewer Groups' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class CloseEditorInAllGroupsAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('closeEditorInAllGroups', "Close Code Viewer in All Groups"), original: 'Close Code Viewer in All Groups' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		});
...
export class MoveGroupLeftAction extends AbstractMoveGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveActiveGroupLeft', "Move Code Viewer Group Left"), original: 'Move Code Viewer Group Left' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveGroupRightAction extends AbstractMoveGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveActiveGroupRight', "Move Code Viewer Group Right"), original: 'Move Code Viewer Group Right' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveGroupUpAction extends AbstractMoveGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveActiveGroupUp', "Move Code Viewer Group Up"), original: 'Move Code Viewer Group Up' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveGroupDownAction extends AbstractMoveGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveActiveGroupDown', "Move Code Viewer Group Down"), original: 'Move Code Viewer Group Down' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class DuplicateGroupLeftAction extends AbstractDuplicateGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('duplicateActiveGroupLeft', "Duplicate Code Viewer Group Left"), original: 'Duplicate Code Viewer Group Left' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		}, GroupDirection.LEFT);
...
export class DuplicateGroupRightAction extends AbstractDuplicateGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('duplicateActiveGroupRight', "Duplicate Code Viewer Group Right"), original: 'Duplicate Code Viewer Group Right' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		}, GroupDirection.RIGHT);
...
export class DuplicateGroupUpAction extends AbstractDuplicateGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('duplicateActiveGroupUp', "Duplicate Code Viewer Group Up"), original: 'Duplicate Code Viewer Group Up' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		}, GroupDirection.UP);
...
export class DuplicateGroupDownAction extends AbstractDuplicateGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('duplicateActiveGroupDown', "Duplicate Code Viewer Group Down"), original: 'Duplicate Code Viewer Group Down' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		}, GroupDirection.DOWN);
...
export class MinimizeOtherGroupsAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('minimizeOtherEditorGroups', "Expand Code Viewer Group"), original: 'Expand Code Viewer Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View,
...
export class MinimizeOtherGroupsHideSidebarAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('minimizeOtherEditorGroupsHideSidebar', "Expand Code Viewer Group and Hide Side Bars"), original: 'Expand Code Viewer Group and Hide Side Bars' },
			/* End AGPL */
			f1: true,
			category: Categories.View,
...
export class OpenNextEditor extends AbstractNavigateEditorAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('openNextEditor', "Open Next Code Viewer"), original: 'Open Next Code Viewer' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class OpenPreviousEditor extends AbstractNavigateEditorAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('openPreviousEditor', "Open Previous Code Viewer"), original: 'Open Previous Code Viewer' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class OpenNextEditorInGroup extends AbstractNavigateEditorAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('nextEditorInGroup', "Open Next Code Viewer in Group"), original: 'Open Next Code Viewer in Group' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class OpenPreviousEditorInGroup extends AbstractNavigateEditorAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('openPreviousEditorInGroup', "Open Previous Code Viewer in Group"), original: 'Open Previous Code Viewer in Group' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class OpenFirstEditorInGroup extends AbstractNavigateEditorAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('firstEditorInGroup', "Open First Code Viewer in Group"), original: 'Open First Code Viewer in Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		});
...
export class OpenLastEditorInGroup extends AbstractNavigateEditorAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('lastEditorInGroup', "Open Last Code Viewer in Group"), original: 'Open Last Code Viewer in Group' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class ReopenClosedEditorAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('reopenClosedEditor', "Reopen Closed Code Viewer"), original: 'Reopen Closed Code Viewer' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class QuickAccessPreviousRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('quickOpenPreviousRecentlyUsedEditor', "Quick Open Previous Recently Used Code Viewer"), original: 'Quick Open Previous Recently Used Code Viewer' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class QuickAccessLeastRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('quickOpenLeastRecentlyUsedEditor', "Quick Open Least Recently Used Code Viewer"), original: 'Quick Open Least Recently Used Code Viewer' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		}, AllEditorsByMostRecentlyUsedQuickAccess.PREFIX, undefined);
...
export class QuickAccessPreviousRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('quickOpenPreviousRecentlyUsedEditorInGroup', "Quick Open Previous Recently Used Code Viewer in Group"), original: 'Quick Open Previous Recently Used Code Viewer in Group' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class QuickAccessLeastRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('quickOpenLeastRecentlyUsedEditorInGroup', "Quick Open Least Recently Used Code Viewer in Group"), original: 'Quick Open Least Recently Used Code Viewer in Group' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class QuickAccessPreviousEditorFromHistoryAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('navigateEditorHistoryByInput', "Quick Open Previous Code Viewer from History"), original: 'Quick Open Previous Code Viewer from History' },
			/* End AGPL */
			f1: true
		});
	}
...
export class OpenNextRecentlyUsedEditorAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('openNextRecentlyUsedEditor', "Open Next Recently Used Code Viewer"), original: 'Open Next Recently Used Code Viewer' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		});
...
export class OpenPreviousRecentlyUsedEditorAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('openPreviousRecentlyUsedEditor', "Open Previous Recently Used Code Viewer"), original: 'Open Previous Recently Used Code Viewer' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		});
...
export class OpenNextRecentlyUsedEditorInGroupAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('openNextRecentlyUsedEditorInGroup', "Open Next Recently Used Code Viewer In Group"), original: 'Open Next Recently Used Code Viewer In Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		});
...
export class OpenPreviousRecentlyUsedEditorInGroupAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('openPreviousRecentlyUsedEditorInGroup', "Open Previous Recently Used Code Viewer In Group"), original: 'Open Previous Recently Used Code Viewer In Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		});
...
export class ClearEditorHistoryAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('clearEditorHistory', "Clear Code Viewer History"), original: 'Clear Code Viewer History' },
			/* End AGPL */
			f1: true
		});
	}
...
export class MoveEditorLeftInGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveEditorLeft', "Move Code Viewer Left"), original: 'Move Code Viewer Left' },
			/* End AGPL */
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveEditorRightInGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveEditorRight', "Move Code Viewer Right"), original: 'Move Code Viewer Right' },
			/* End AGPL */
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveEditorToPreviousGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveEditorToPreviousGroup', "Move Code Viewer into Previous Group"), original: 'Move Code Viewer into Previous Group' },
			/* End AGPL */
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
				primary: KeyMod.CtrlCmd | KeyMod.Alt | KeyCode.LeftArrow,
...
export class MoveEditorToNextGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveEditorToNextGroup', "Move Code Viewer into Next Group"), original: 'Move Code Viewer into Next Group' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveEditorToAboveGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveEditorToAboveGroup', "Move Code Viewer into Group Above"), original: 'Move Code Viewer into Group Above' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class MoveEditorToBelowGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveEditorToBelowGroup', "Move Code Viewer into Group Below"), original: 'Move Code Viewer into Group Below' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class MoveEditorToLeftGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveEditorToLeftGroup', "Move Code Viewer into Left Group"), original: 'Move Code Viewer into Left Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class MoveEditorToRightGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveEditorToRightGroup', "Move Code Viewer into Right Group"), original: 'Move Code Viewer into Right Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class MoveEditorToFirstGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveEditorToFirstGroup', "Move Code Viewer into First Group"), original: 'Move Code Viewer into First Group' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveEditorToLastGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('moveEditorToLastGroup', "Move Code Viewer into Last Group"), original: 'Move Code Viewer into Last Group' },
			/* End AGPL */
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class SplitEditorToPreviousGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('splitEditorToPreviousGroup', "Split Code Viewer into Previous Group"), original: 'Split Code Viewer into Previous Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class SplitEditorToNextGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('splitEditorToNextGroup', "Split Code Viewer into Next Group"), original: 'Split Code Viewer into Next Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class SplitEditorToAboveGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('splitEditorToAboveGroup', "Split Code Viewer into Group Above"), original: 'Split Code Viewer into Group Above' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class SplitEditorToBelowGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('splitEditorToBelowGroup', "Split Code Viewer into Group Below"), original: 'Split Code Viewer into Group Below' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class SplitEditorToLeftGroupAction extends ExecuteCommandAction {
	...
	static readonly LABEL = localize('splitEditorToLeftGroup', "Split Code Viewer into Left Group");

	constructor() {
		super({
			id: 'workbench.action.splitEditorToLeftGroup',
			/* AGPL */
			title: { value: localize('splitEditorToLeftGroup', "Split Code Viewer into Left Group"), original: 'Split Code Viewer into Left Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class SplitEditorToRightGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('splitEditorToRightGroup', "Split Code Viewer into Right Group"), original: 'Split Code Viewer into Right Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class SplitEditorToFirstGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('splitEditorToFirstGroup', "Split Code Viewer into First Group"), original: 'Split Code Viewer into First Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class SplitEditorToLastGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('splitEditorToLastGroup', "Split Code Viewer into Last Group"), original: 'Split Code Viewer into Last Group' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class EditorLayoutSingleAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('editorLayoutSingle', "Single Column Code Viewer Layout"), original: 'Single Column Code Viewer Layout' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class EditorLayoutTwoColumnsAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('editorLayoutTwoColumns', "Two Columns Code Viewer Layout"), original: 'Two Columns Code Viewer Layout' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class EditorLayoutThreeColumnsAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('editorLayoutThreeColumns', "Three Columns Code Viewer Layout"), original: 'Three Columns Code Viewer Layout' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		}, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}, {}], orientation: GroupOrientation.HORIZONTAL } as EditorGroupLayout);
...
export class EditorLayoutTwoRowsAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('editorLayoutTwoRows', "Two Rows Code Viewer Layout"), original: 'Two Rows Code Viewer Layout' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class EditorLayoutThreeRowsAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('editorLayoutThreeRows', "Three Rows Code Viewer Layout"), original: 'Three Rows Code Viewer Layout' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		}, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}, {}], orientation: GroupOrientation.VERTICAL } as EditorGroupLayout);
...
export class EditorLayoutTwoByTwoGridAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('editorLayoutTwoByTwoGrid', "Grid Code Viewer Layout (2x2)"), original: 'Grid Code Viewer Layout (2x2)' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class EditorLayoutTwoColumnsBottomAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('editorLayoutTwoColumnsBottom', "Two Columns Bottom Code Viewer Layout"), original: 'Two Columns Bottom Code Viewer Layout' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class EditorLayoutTwoRowsRightAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('editorLayoutTwoRowsRight', "Two Rows Right Code Viewer Layout"), original: 'Two Rows Right Code Viewer Layout' },
			/* End AGPL */
			f1: true,
			category: Categories.View
...
export class NewEditorGroupLeftAction extends AbstractCreateEditorGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('newGroupLeft', "New Code Viewer Group to the Left"), original: 'New Code Viewer Group to the Left' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		}, GroupDirection.LEFT);
...
export class NewEditorGroupRightAction extends AbstractCreateEditorGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('newGroupRight', "New Code Viewer Group to the Right"), original: 'New Code Viewer Group to the Right' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		}, GroupDirection.RIGHT);
...
export class NewEditorGroupAboveAction extends AbstractCreateEditorGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('newGroupAbove', "New Code Viewer Group Above"), original: 'New Code Viewer Group Above' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		}, GroupDirection.UP);
...
export class NewEditorGroupBelowAction extends AbstractCreateEditorGroupAction {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('newGroupBelow', "New Code Viewer Group Below"), original: 'New Code Viewer Group Below' },
			/* End AGPL */
			f1: true,
			category: Categories.View
		}, GroupDirection.DOWN);
...
export class ToggleEditorTypeAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('toggleEditorType', "Toggle Code Viewer Type"), original: 'Toggle Code Viewer Type' },
			/* End AGPL */
			f1: true,
			category: Categories.View,
...
export class ReOpenInTextEditorAction extends Action2 {
	...
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: localize('reopenTextEditor', "Reopen Code Viewer With Text Editor"), original: 'Reopen Code Viewer With Text Editor' },
			/* End AGPL */
			f1: true,
			category: Categories.View,
			precondition: ActiveEditorAvailableEditorIdsContext
