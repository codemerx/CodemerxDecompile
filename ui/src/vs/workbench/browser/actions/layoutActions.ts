...
registerAction2(class extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				/* AGPL */
				value: localize('toggleEditor', "Toggle Code Viewer Area Visibility"),
				mnemonicTitle: localize({ key: 'miShowEditorArea', comment: ['&& denotes a mnemonic'] }, "Show &&Code Viewer Area"),
				original: 'Toggle Code Viewer Area Visibility'
				/* End AGPL */
			},
			category: Categories.View,
			f1: true,
