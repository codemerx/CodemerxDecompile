	...
	public class UpdateViewModel : ViewModelBase<MixCmsContext, MixCmsUser, UpdateViewModel>
	{
		...
		public List<NavUserRoleViewModel> GetRoleNavs()
		{
			...
			try
			{
				...
				// Current member / type: System.Collections.Generic.List`1<Mix.Cms.Lib.ViewModels.Account.NavUserRoleViewModel> Mix.Cms.Lib.ViewModels.Account.MixUsers.UpdateViewModel::GetRoleNavs()
