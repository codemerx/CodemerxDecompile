...
namespace Mix.Cms.Lib.Controllers
{
	...
	where TView : ViewModelBase<TDbContext, TModel, TView>
	{
		...
		public async Task<ActionResult> ClearCacheAsync(string id)
		{
			...
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cClearCacheAsyncu003ed__8>(ref V_0);
		...
		public async Task<ActionResult> ClearCacheAsync()
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<ActionResult>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cClearCacheAsyncu003ed__9>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		public async Task<ActionResult<TModel>> Create([FromBody] TView data)
		{
			...
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cCreateu003ed__10>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		public virtual async Task<ActionResult<TModel>> Delete(string id)
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<ActionResult<TModel>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cDeleteu003ed__13>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		where T : ViewModelBase<TDbContext, TModel, T>
		{
			...
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cDeleteAsyncu003ed__20<T>>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		protected async Task<RepositoryResponse<TModel>> DeleteAsync(string id, bool isDeleteRelated = false)
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<RepositoryResponse<TModel>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cDeleteAsyncu003ed__21>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		protected async Task<RepositoryResponse<TModel>> DeleteAsync(TView data, bool isDeleteRelated = false)
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<RepositoryResponse<TModel>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cDeleteAsyncu003ed__22>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		where T : ViewModelBase<TDbContext, TModel, T>
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<RepositoryResponse<TModel>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cDeleteAsyncu003ed__23<T>>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		protected async Task<RepositoryResponse<List<TModel>>> DeleteListAsync(Expression<Func<TModel, bool>> predicate, bool isRemoveRelatedModel = false)
		{
			...
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cDeleteListAsyncu003ed__24>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		protected async Task<RepositoryResponse<FileViewModel>> ExportListAsync(Expression<Func<TModel, bool>> predicate, string type)
		{
			...
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cExportListAsyncu003ed__25>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		{
			V_0.u003cu003e4__this = this;
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<ActionResult<PaginationModel<TView>>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cGetu003ed__5>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		public async Task<ActionResult<TView>> Get(string id)
		{
			...
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cGetu003ed__6>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		protected async Task<RepositoryResponse<PaginationModel<TView>>> GetListAsync(Expression<Func<TModel, bool>> predicate = null)
		{
			...
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cGetListAsyncu003ed__26>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		where T : ViewModelBase<TDbContext, TModel, T>
		{
			...
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cGetSingleAsyncu003ed__16<T>>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		protected async Task<RepositoryResponse<TView>> GetSingleAsync(string id)
		{
			...
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cGetSingleAsyncu003ed__17>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		protected async Task<RepositoryResponse<TView>> GetSingleAsync(Expression<Func<TModel, bool>> predicate = null)
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<RepositoryResponse<TView>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cGetSingleAsyncu003ed__18>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		where T : ViewModelBase<TDbContext, TModel, T>
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<RepositoryResponse<T>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cGetSingleAsyncu003ed__19<T>>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		public override void OnActionExecuting(ActionExecutingContext context)
		{
			...
			if (MixService.GetIpConfig<bool>("IsRetrictIp"))
			{
				...
				if (stackVariable18 == null)
				{
					...
					stackVariable18 = new Func<JToken, bool>(BaseRestApiController<TDbContext, TModel, TView>.u003cu003ec.u003cu003e9, BaseRestApiController<TDbContext, TModel, TView>.u003cu003ec.u003cOnActionExecutingu003eb__14_0);
					BaseRestApiController<TDbContext, TModel, TView>.u003cu003ec.u003cu003e9__14_0 = stackVariable18;
				}
				if (!Enumerable.Any<JToken>(stackVariable17, stackVariable18) && !V_1.Contains(JToken.op_Implicit(V_0.remoteIp)) || Enumerable.Any<JToken>(V_2, new Func<JToken, bool>(V_0, BaseRestApiController<TDbContext, TModel, TView>.u003cu003ec__DisplayClass14_0.u003cOnActionExecutingu003eb__1)))
				{
		...
		public async Task<IActionResult> Patch(string id, [FromBody] JObject fields)
		{
			...
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cPatchu003ed__12>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		protected async Task<RepositoryResponse<TView>> SaveAsync(TView vm, bool isSaveSubModel)
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<RepositoryResponse<TView>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cSaveAsyncu003ed__27>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		protected async Task<RepositoryResponse<TModel>> SaveAsync(JObject obj, Expression<Func<TModel, bool>> predicate)
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<RepositoryResponse<TModel>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cSaveAsyncu003ed__28>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		protected async Task<RepositoryResponse<List<TView>>> SaveListAsync(List<TView> lstVm, bool isSaveSubModel)
		{
			...
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cSaveListAsyncu003ed__29>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		public async Task<IActionResult> Update(string id, [FromBody] TView data)
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<IActionResult>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<BaseRestApiController<TDbContext, TModel, TView>.u003cUpdateu003ed__11>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
	}
}