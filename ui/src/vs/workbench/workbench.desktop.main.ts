...
import { IEnvironmentRpcService, EnvironmentRpcService } from 'vs/cd/workbench/EnvironmentRpcService';
...
registerSingleton(IEnvironmentRpcService, EnvironmentRpcService);
