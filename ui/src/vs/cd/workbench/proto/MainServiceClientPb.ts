...
export class RpcDecompilerClient {
  ...
  methodInfoGetProjectCreationMetadataFromTypeFilePath = new grpcWeb.AbstractClientBase.MethodInfo(
    main_pb.GetProjectCreationMetadataFromTypeFilePathResponse,
    (request: main_pb.GetProjectCreationMetadataFromTypeFilePathRequest) => {
      return request.serializeBinary();
    },
    main_pb.GetProjectCreationMetadataFromTypeFilePathResponse.deserializeBinary
  );

  getProjectCreationMetadataFromTypeFilePath(
    request: main_pb.GetProjectCreationMetadataFromTypeFilePathRequest,
    metadata: grpcWeb.Metadata | null): Promise<main_pb.GetProjectCreationMetadataFromTypeFilePathResponse>;

  getProjectCreationMetadataFromTypeFilePath(
    request: main_pb.GetProjectCreationMetadataFromTypeFilePathRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: main_pb.GetProjectCreationMetadataFromTypeFilePathResponse) => void): grpcWeb.ClientReadableStream<main_pb.GetProjectCreationMetadataFromTypeFilePathResponse>;

  getProjectCreationMetadataFromTypeFilePath(
    request: main_pb.GetProjectCreationMetadataFromTypeFilePathRequest,
    metadata: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.Error,
               response: main_pb.GetProjectCreationMetadataFromTypeFilePathResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/RpcDecompiler/GetProjectCreationMetadataFromTypeFilePath',
        request,
        metadata || {},
        this.methodInfoGetProjectCreationMetadataFromTypeFilePath,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
  ...
  methodInfoCreateProject = new grpcWeb.AbstractClientBase.MethodInfo(
    main_pb.CreateProjectResponse,
    (request: main_pb.CreateProjectRequest) => {
      return request.serializeBinary();
    },
    main_pb.CreateProjectResponse.deserializeBinary
  );

  createProject(
    request: main_pb.CreateProjectRequest,
    metadata: grpcWeb.Metadata | null): Promise<main_pb.CreateProjectResponse>;

  createProject(
    request: main_pb.CreateProjectRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: main_pb.CreateProjectResponse) => void): grpcWeb.ClientReadableStream<main_pb.CreateProjectResponse>;

  createProject(
    request: main_pb.CreateProjectRequest,
    metadata: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.Error,
               response: main_pb.CreateProjectResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/RpcDecompiler/CreateProject',
        request,
        metadata || {},
