	...
	internal class MixChatServiceContextModelSnapshot : ModelSnapshot
	{
		...
		protected override void BuildModel(ModelBuilder modelBuilder)
		{
			...
			if (stackVariable6 == null)
			{
				...
				stackVariable6 = new Action<EntityTypeBuilder>(MixChatServiceContextModelSnapshot.u003cu003ec.u003cu003e9, MixChatServiceContextModelSnapshot.u003cu003ec.u003cBuildModelu003eb__0_0);
			...
			if (stackVariable10 == null)
			{
				...
				stackVariable10 = new Action<EntityTypeBuilder>(MixChatServiceContextModelSnapshot.u003cu003ec.u003cu003e9, MixChatServiceContextModelSnapshot.u003cu003ec.u003cBuildModelu003eb__0_1);
			...
			if (stackVariable14 == null)
			{
				...
				stackVariable14 = new Action<EntityTypeBuilder>(MixChatServiceContextModelSnapshot.u003cu003ec.u003cu003e9, MixChatServiceContextModelSnapshot.u003cu003ec.u003cBuildModelu003eb__0_2);
			...
			if (stackVariable18 == null)
			{
				...
				stackVariable18 = new Action<EntityTypeBuilder>(MixChatServiceContextModelSnapshot.u003cu003ec.u003cu003e9, MixChatServiceContextModelSnapshot.u003cu003ec.u003cBuildModelu003eb__0_3);
			...
			if (stackVariable22 == null)
			{
				...
				stackVariable22 = new Action<EntityTypeBuilder>(MixChatServiceContextModelSnapshot.u003cu003ec.u003cu003e9, MixChatServiceContextModelSnapshot.u003cu003ec.u003cBuildModelu003eb__0_4);
			...
			if (stackVariable26 == null)
			{
				...
				stackVariable26 = new Action<EntityTypeBuilder>(MixChatServiceContextModelSnapshot.u003cu003ec.u003cu003e9, MixChatServiceContextModelSnapshot.u003cu003ec.u003cBuildModelu003eb__0_5);
			...
			if (stackVariable30 == null)
			{
				...
				stackVariable30 = new Action<EntityTypeBuilder>(MixChatServiceContextModelSnapshot.u003cu003ec.u003cu003e9, MixChatServiceContextModelSnapshot.u003cu003ec.u003cBuildModelu003eb__0_6);
			...
			if (stackVariable34 == null)
			{
				...
				stackVariable34 = new Action<EntityTypeBuilder>(MixChatServiceContextModelSnapshot.u003cu003ec.u003cu003e9, MixChatServiceContextModelSnapshot.u003cu003ec.u003cBuildModelu003eb__0_7);
			...
			if (stackVariable38 == null)
			{
				...
				stackVariable38 = new Action<EntityTypeBuilder>(MixChatServiceContextModelSnapshot.u003cu003ec.u003cu003e9, MixChatServiceContextModelSnapshot.u003cu003ec.u003cBuildModelu003eb__0_8);
			...
			if (stackVariable42 == null)
			{
				...
				stackVariable42 = new Action<EntityTypeBuilder>(MixChatServiceContextModelSnapshot.u003cu003ec.u003cu003e9, MixChatServiceContextModelSnapshot.u003cu003ec.u003cBuildModelu003eb__0_9);
