...
namespace Mix.Cms.Lib.ViewModels.MixThemes
{
	public class UpdateViewModel : ViewModelBase<MixCmsContext, MixTheme, Mix.Cms.Lib.ViewModels.MixThemes.UpdateViewModel>
	{
		...
		public UpdateViewModel(MixTheme model, MixCmsContext _context = null, IDbContextTransaction _transaction = null) : base(model, _context, _transaction)
		{
		}
		...
		{
			this.Templates = ViewModelBase<MixCmsContext, MixTemplate, Mix.Cms.Lib.ViewModels.MixTemplates.UpdateViewModel>.Repository.GetModelListBy((MixTemplate t) => t.ThemeId == this.Id, _context, _transaction).get_Data();
		...
		private async Task InitAssetStyleAsync(MixCmsContext _context = null, IDbContextTransaction _transaction = null)
		{
			...
			BinaryExpression binaryExpression = Expression.AndAlso(Expression.Equal(Expression.Property(parameterExpression, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(MixTemplate).GetMethod("get_FileName").MethodHandle)), Expression.Constant("_Layout", typeof(string))), Expression.Equal(Expression.Property(parameterExpression, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(MixTemplate).GetMethod("get_ThemeId").MethodHandle)), Expression.Property(Expression.Property(Expression.Constant(this, typeof(Mix.Cms.Lib.ViewModels.MixThemes.UpdateViewModel)), (MethodInfo)MethodBase.GetMethodFromHandle(typeof(ViewModelBase<MixCmsContext, MixTheme, Mix.Cms.Lib.ViewModels.MixThemes.UpdateViewModel>).GetMethod("get_Model").MethodHandle, typeof(ViewModelBase<MixCmsContext, MixTheme, Mix.Cms.Lib.ViewModels.MixThemes.UpdateViewModel>).TypeHandle)), (MethodInfo)MethodBase.GetMethodFromHandle(typeof(MixTheme).GetMethod("get_Id").MethodHandle))));
		...
		public override MixTheme ParseModel(MixCmsContext _context = null, IDbContextTransaction _transaction = null)
		{
			if (this.Id == 0)
			{
				this.Id = ViewModelBase<MixCmsContext, MixTheme, Mix.Cms.Lib.ViewModels.MixThemes.UpdateViewModel>.Repository.Max((MixTheme m) => m.Id, null, null).get_Data() + 1;
		...
		public override async Task<RepositoryResponse<bool>> SaveSubModelsAsync(MixTheme parent, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
		{
			...
			if (repositoryResponse1.get_IsSucceed() && !string.IsNullOrEmpty(this.Asset.Filename))
			{
				repositoryResponse1 = this.ImportAssetsAsync(_context, _transaction);
			}
			if (this.IsActived)
			{
