...
namespace AsyncTestCollectionNet45VS2013
{
	internal class Program
	{
		...
		{
			Program.u003cInfiniteWhileForForeachu003ed__36 variable = new Program.u003cInfiniteWhileForForeachu003ed__36();
			variable.durations = durations;
			variable.u003cu003et__builder = AsyncTaskMethodBuilder.Create();
			variable.u003cu003e1__state = -1;
			variable.u003cu003et__builder.Start<Program.u003cInfiniteWhileForForeachu003ed__36>(ref variable);
