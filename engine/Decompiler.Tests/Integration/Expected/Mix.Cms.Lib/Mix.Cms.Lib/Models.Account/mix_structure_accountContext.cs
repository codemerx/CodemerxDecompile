...
namespace Mix.Cms.Lib.Models.Account
{
	public class mix_structure_accountContext : DbContext
	{
		...
		public mix_structure_accountContext(DbContextOptions<mix_structure_accountContext> options) : base(options)
		{
		}
		...
		protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
		{
			...
			{
				SqlServerDbContextOptionsExtensions.UseSqlServer(optionsBuilder, "Server=115.79.139.90,4444;Database=mix_structure_account;UID=tinku;Pwd=1234qwe@;MultipleActiveResultSets=true;", null);
			}
		}
