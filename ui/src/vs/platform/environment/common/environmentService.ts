...
export abstract class AbstractNativeEnvironmentService implements INativeEnvironmentService {
	...
	/* AGPL */
	@memoize
	get codemerxDecompileLogResource(): URI { return URI.joinPath(this.logsHome, 'CodemerxDecompile.log'); }
	
	@memoize
	get sourcesDir(): URI { return URI.file(join(this.userDataPath, 'sources')); }
	/* End AGPL */
