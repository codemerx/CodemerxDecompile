...
namespace Mix.Cms.Lib.ViewModels.MixTemplates
{
	public class UpdateViewModel : ViewModelBase<MixCmsContext, MixTemplate, UpdateViewModel>
	{
		...
		public UpdateViewModel(MixTemplate model, MixCmsContext _context = null, IDbContextTransaction _transaction = null) : base(model, _context, _transaction)
		{
		}

		public async Task<RepositoryResponse<UpdateViewModel>> CopyAsync()
		{
			DefaultRepository<!0, !1, !2> repository = ViewModelBase<MixCmsContext, MixTemplate, UpdateViewModel>.Repository;
			RepositoryResponse<UpdateViewModel> singleModelAsync = await repository.GetSingleModelAsync((MixTemplate m) => m.Id == this.Id, null, null);
			singleModelAsync.get_Data().Id = 0;
			singleModelAsync.get_Data().FileName = string.Concat("Copy_", singleModelAsync.get_Data().FileName);
			RepositoryResponse<UpdateViewModel> repositoryResponse = await singleModelAsync.get_Data().SaveModelAsync(false, null, null);
		...
		{
			UpdateViewModel.u003cu003ec__DisplayClass92_0 variable = null;
			string[] strArrays;
			RepositoryResponse<UpdateViewModel> repositoryResponse = new RepositoryResponse<UpdateViewModel>();
			if (path != null)
			{
		...
		{
			UpdateViewModel.u003cu003ec__DisplayClass93_0 variable = null;
			string str;
			if (path != null)
			{
			...
			DefaultRepository<!0, !1, !2> repository = ViewModelBase<MixCmsContext, MixTemplate, UpdateViewModel>.Repository;
			ParameterExpression parameterExpression = Expression.Parameter(typeof(MixTemplate), "t");
			return repository.GetSingleModel(Expression.Lambda<Func<MixTemplate, bool>>(Expression.AndAlso(Expression.AndAlso(Expression.AndAlso(Expression.Equal(Expression.Property(parameterExpression, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(MixTemplate).GetMethod("get_ThemeId").MethodHandle)), Expression.Field(Expression.Constant(variable, typeof(UpdateViewModel.u003cu003ec__DisplayClass93_0)), FieldInfo.GetFieldFromHandle(typeof(UpdateViewModel.u003cu003ec__DisplayClass93_0).GetField("themeId").FieldHandle))), Expression.Equal(Expression.Property(parameterExpression, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(MixTemplate).GetMethod("get_FolderType").MethodHandle)), Expression.Call(Expression.Field(Expression.Constant(variable, typeof(UpdateViewModel.u003cu003ec__DisplayClass93_0)), FieldInfo.GetFieldFromHandle(typeof(UpdateViewModel.u003cu003ec__DisplayClass93_0).GetField("folderType").FieldHandle)), (MethodInfo)MethodBase.GetMethodFromHandle(typeof(object).GetMethod("ToString").MethodHandle), Array.Empty<Expression>()))), Expression.Not(Expression.Call(null, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(string).GetMethod("IsNullOrEmpty", new Type[] { typeof(string) }).MethodHandle), new Expression[] { Expression.Field(Expression.Constant(variable, typeof(UpdateViewModel.u003cu003ec__DisplayClass93_0)), FieldInfo.GetFieldFromHandle(typeof(UpdateViewModel.u003cu003ec__DisplayClass93_0).GetField("templateName").FieldHandle)) }))), Expression.Call(Expression.Field(Expression.Constant(variable, typeof(UpdateViewModel.u003cu003ec__DisplayClass93_0)), FieldInfo.GetFieldFromHandle(typeof(UpdateViewModel.u003cu003ec__DisplayClass93_0).GetField("templateName").FieldHandle)), (MethodInfo)MethodBase.GetMethodFromHandle(typeof(string).GetMethod("Equals", new Type[] { typeof(string) }).MethodHandle), new Expression[] { Expression.Call(null, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(string).GetMethod("Format", new Type[] { typeof(string), typeof(object), typeof(object) }).MethodHandle), new Expression[] { Expression.Constant("{0}{1}", typeof(string)), Expression.Property(parameterExpression, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(MixTemplate).GetMethod("get_FileName").MethodHandle)), Expression.Property(parameterExpression, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(MixTemplate).GetMethod("get_Extension").MethodHandle)) }) })), new ParameterExpression[] { parameterExpression }), _context, _transaction).get_Data() ?? UpdateViewModel.GetDefault(folderType, specificulture);
		}
		...
		public override MixTemplate ParseModel(MixCmsContext _context = null, IDbContextTransaction _transaction = null)
		{
			...
			if (this.Id == 0)
			{
				this.Id = ViewModelBase<MixCmsContext, MixTemplate, UpdateViewModel>.Repository.Max((MixTemplate m) => m.Id, _context, _transaction).get_Data() + 1;
		...
		{
			RepositoryResponse<UpdateViewModel> repositoryResponse = await this.u003cu003en__0(isSaveSubModels, _context, _transaction);
