...
export class OpenEditorsView extends ViewPane {
	...
	/* AGPL */
	static readonly NAME: ILocalizedString = nls.localize2({ key: 'openTypes', comment: ['Open is an adjective'] }, "Open Types");
	/* End AGPL */
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			/* AGPL */
			title: { value: nls.localize('flipLayout', "Toggle Vertical/Horizontal Code Viewer Layout"), original: 'Toggle Vertical/Horizontal Code Viewer Layout' },
			/* End AGPL */
			f1: true,
			keybinding: {
