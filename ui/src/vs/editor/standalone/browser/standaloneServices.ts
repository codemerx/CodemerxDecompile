...
class StandaloneEnvironmentService implements IEnvironmentService {
	...
	readonly codemerxDecompileLogResource: URI = URI.from({ scheme: 'monaco', authority: 'codemerxDecompileLogResource' });
	readonly sourcesDir: URI = URI.from({ scheme: 'monaco', authority: 'sourcesDir' });
}
