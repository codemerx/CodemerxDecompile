...
namespace Mix.Cms.Lib.ViewModels.MixPortalPagePortalPages
{
	public class ReadViewModel : ViewModelBase<MixCmsContext, MixPortalPageNavigation, Mix.Cms.Lib.ViewModels.MixPortalPagePortalPages.ReadViewModel>
	{
		...
		{
			RepositoryResponse<List<Mix.Cms.Lib.ViewModels.MixPortalPagePortalPages.ReadViewModel>> repositoryResponse;
			...
			RepositoryResponse<List<Mix.Cms.Lib.ViewModels.MixPortalPagePortalPages.ReadViewModel>> repositoryResponse1 = new RepositoryResponse<List<Mix.Cms.Lib.ViewModels.MixPortalPagePortalPages.ReadViewModel>>();
			try
			{
				try
				{
					foreach (Mix.Cms.Lib.ViewModels.MixPortalPagePortalPages.ReadViewModel cate in cates)
					{
						RepositoryResponse<Mix.Cms.Lib.ViewModels.MixPortalPagePortalPages.ReadViewModel> repositoryResponse2 = await cate.SaveModelAsync(false, mixCmsContext, dbContextTransaction);
				...
				catch (Exception exception1)
				{
					...
					UnitOfWorkHelper<MixCmsContext>.HandleException<Mix.Cms.Lib.ViewModels.MixPortalPagePortalPages.ReadViewModel>(exception, true, dbContextTransaction);
					RepositoryResponse<List<Mix.Cms.Lib.ViewModels.MixPortalPagePortalPages.ReadViewModel>> repositoryResponse3 = new RepositoryResponse<List<Mix.Cms.Lib.ViewModels.MixPortalPagePortalPages.ReadViewModel>>();
