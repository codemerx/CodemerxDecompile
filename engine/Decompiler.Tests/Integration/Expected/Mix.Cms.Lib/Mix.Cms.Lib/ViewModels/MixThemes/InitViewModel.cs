...
namespace Mix.Cms.Lib.ViewModels.MixThemes
{
	public class InitViewModel : ViewModelBase<MixCmsContext, MixTheme, Mix.Cms.Lib.ViewModels.MixThemes.InitViewModel>
	{
		...
		{
			Mix.Cms.Lib.ViewModels.MixThemes.InitViewModel.u003cCreateDefaultThemeTemplatesAsyncu003ed__81 variable = new Mix.Cms.Lib.ViewModels.MixThemes.InitViewModel.u003cCreateDefaultThemeTemplatesAsyncu003ed__81();
			...
			variable.u003cu003et__builder.Start<Mix.Cms.Lib.ViewModels.MixThemes.InitViewModel.u003cCreateDefaultThemeTemplatesAsyncu003ed__81>(ref variable);
