...
namespace Piranha.Models
{
	...
	public sealed class PostType : ContentTypeBase
	{
		...
		public void Ensure()
		{
			...
			stackVariable2 = PostType.u003cu003ec.u003cu003e9__12_0;
			if (stackVariable2 == null)
			{
				dummyVar0 = stackVariable2;
				stackVariable2 = new Func<RegionType, string>(PostType.u003cu003ec.u003cu003e9.u003cEnsureu003eb__12_0);
				PostType.u003cu003ec.u003cu003e9__12_0 = stackVariable2;
			}
			...
			try
			{
				while (V_0.MoveNext())
				{
					...
					stackVariable21 = PostType.u003cu003ec.u003cu003e9__12_1;
					if (stackVariable21 == null)
					{
						dummyVar2 = stackVariable21;
						stackVariable21 = new Func<FieldType, string>(PostType.u003cu003ec.u003cu003e9.u003cEnsureu003eb__12_1);
						PostType.u003cu003ec.u003cu003e9__12_1 = stackVariable21;
					}
