...
namespace Mix.Cms.Lib.ViewModels.MixAttributeSetDatas
{
	public class FormPortalViewModel : ViewModelBase<MixCmsContext, MixAttributeSetData, FormPortalViewModel>
	{
		...
		[JsonIgnore]
		public List<FormPortalViewModel> RefData
		{
			get;
			set;
		}
		...
		public FormPortalViewModel()
		{
			...
			this.u003cRefDatau003ek__BackingField = new List<FormPortalViewModel>();
			base();
			return;
		}

		public FormPortalViewModel(MixAttributeSetData model, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
		{
			this.u003cRelatedDatau003ek__BackingField = new List<Mix.Cms.Lib.ViewModels.MixRelatedAttributeDatas.UpdateViewModel>();
			this.u003cRefDatau003ek__BackingField = new List<FormPortalViewModel>();
		...
		{
			V_0 = new FormPortalViewModel.u003cu003ec__DisplayClass84_0();
			V_0.culture = culture;
		...
		private void ParseData(MixCmsContext _context = null, IDbContextTransaction _transaction = null)
		{
			...
			// Current member / type: System.Void Mix.Cms.Lib.ViewModels.MixAttributeSetDatas.FormPortalViewModel::ParseData(Mix.Cms.Lib.Models.Cms.MixCmsContext,Microsoft.EntityFrameworkCore.Storage.IDbContextTransaction)
		...
		public override MixAttributeSetData ParseModel(MixCmsContext _context = null, IDbContextTransaction _transaction = null)
		{
			if (string.IsNullOrEmpty(this.get_Id()))
			{
				...
				stackVariable415 = ViewModelBase<MixCmsContext, MixAttributeSetData, FormPortalViewModel>.Repository;
				V_4 = Expression.Parameter(Type.GetTypeFromHandle(// 
				// Current member / type: Mix.Cms.Lib.Models.Cms.MixAttributeSetData Mix.Cms.Lib.ViewModels.MixAttributeSetDatas.FormPortalViewModel::ParseModel(Mix.Cms.Lib.Models.Cms.MixCmsContext,Microsoft.EntityFrameworkCore.Storage.IDbContextTransaction)
		...
		private void ParseModelValue(JToken property, Mix.Cms.Lib.ViewModels.MixAttributeSetValues.UpdateViewModel item)
		{
			...
			switch (item.get_Field().get_DataType())
			{
				...
				case 18:
				{
					...
					stackVariable71 = item;
					stackVariable73 = Newtonsoft.Json.Linq.Extensions.Value<string>(property);
					if (stackVariable73 != null)
					{
						stackVariable74 = stackVariable73.ToLower();
					}
					else
					{
						dummyVar2 = stackVariable73;
						stackVariable74 = null;
					}
					stackVariable71.set_StringValue(stackVariable74);
					return;
				}
				case 22:
				{
		...
		public override async Task<RepositoryResponse<FormPortalViewModel>> SaveModelAsync(bool isSaveSubModels = false, MixCmsContext _context = null, IDbContextTransaction _transaction = null)
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<RepositoryResponse<FormPortalViewModel>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<FormPortalViewModel.u003cSaveModelAsyncu003ed__76>(ref V_0);
		...
		public static async Task<RepositoryResponse<Mix.Cms.Lib.ViewModels.MixAttributeSetDatas.FormViewModel>> SaveObjectAsync(JObject data, string attributeSetName)
		{
			...
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<FormPortalViewModel.u003cSaveObjectAsyncu003ed__86>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		private async Task<RepositoryResponse<bool>> SaveRefDataAsync(MixAttributeSetData parent, MixCmsContext context, IDbContextTransaction transaction)
		{
			...
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<FormPortalViewModel.u003cSaveRefDataAsyncu003ed__80>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		private async Task<RepositoryResponse<bool>> SaveRelatedDataAsync(MixAttributeSetData parent, MixCmsContext context, IDbContextTransaction transaction)
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<RepositoryResponse<bool>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<FormPortalViewModel.u003cSaveRelatedDataAsyncu003ed__81>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		public override async Task<RepositoryResponse<bool>> SaveSubModelsAsync(MixAttributeSetData parent, MixCmsContext _context, IDbContextTransaction _transaction)
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<RepositoryResponse<bool>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<FormPortalViewModel.u003cSaveSubModelsAsyncu003ed__78>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
		...
		private async Task<RepositoryResponse<bool>> SaveValues(MixAttributeSetData parent, MixCmsContext context, IDbContextTransaction transaction)
		{
			...
			V_0.u003cu003et__builder = AsyncTaskMethodBuilder<RepositoryResponse<bool>>.Create();
			V_0.u003cu003e1__state = -1;
			V_0.u003cu003et__builder.Start<FormPortalViewModel.u003cSaveValuesu003ed__79>(ref V_0);
			return V_0.u003cu003et__builder.get_Task();
		}
	}
}