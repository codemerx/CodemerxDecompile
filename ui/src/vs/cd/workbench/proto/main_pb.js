 ...
 * @return {string}
 */
proto.GetMemberDefinitionRequest.prototype.getAbsolutefilepath = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.GetMemberDefinitionRequest.prototype.setAbsolutefilepath = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
...
proto.GetMemberDefinitionResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    navigationfilepath: jspb.Message.getFieldWithDefault(msg, 1, ""),
...
proto.GetMemberDefinitionResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.setNavigationfilepath(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
...
proto.GetMemberDefinitionResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getNavigationfilepath();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string navigationFilePath = 1;
 * @return {string}
 */
proto.GetMemberDefinitionResponse.prototype.getNavigationfilepath = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.GetMemberDefinitionResponse.prototype.setNavigationfilepath = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
